# https://github.com/devMEremenko/XcodeBenchmark/blob/master/benchmark.sh

readonly PATH_TO_PROJECT=$(pwd)/BenchmarkSample.xcworkspace
...
if [ -n "$PATH_TO_PROJECT" ]; then
    ...
    echo "xcworkspace was not found in the current folder."
fi
